...
### 14. Packet Start (Packet Start Address)

**Type:** Integer  
**Purpose:** First register address in the packet

**Forward Transformation:**
```
Register Config: packet_start = 1000
         ↓
(Auto-calculated from packet members)
```
...
(Not stored in firmware JSON)
         ↓
Register Config: packet_start = (empty or manual entry)
```

**Auto-Filled:**
If you assign parameters to packets, this is calculated automatically.

---

### 15. Packet Regs (Packet Register Count)

**Type:** Integer  
**Purpose:** Total number of registers in the packet

**Forward Transformation:**
```
Register Config: packet_regs = 5
         ↓
(Auto-calculated from packet members)
```
...
(Not stored in firmware JSON)
         ↓
Register Config: packet_regs = (empty or manual entry)
```

**Auto-Filled:**
Sum of all register lengths in the packet.
...
## 📦 Part 5: Legacy Packet Fields

These 3 fields are from older firmware versions. Visible but mostly replaced by transparent config.

---

### 23-25. Legacy Packet Fields

**Fields:**
- **Packet Num**: Old packet number (replaced by Packet #)
- **Packet SA**: Old packet start address (replaced by Packet Start)
- **Packet NRT**: Old packet register count (replaced by Packet Regs)

**Status:** Deprecated but kept for backward compatibility with old firmware.

**Recommendation:** Use the transparent packet fields (Packet #, Packet Start, Packet Regs) instead.
