...
**✨ Updated for Version 6.7+ with Manual Override & Bug Fixes:**
- **NEW:** Manual Override mode for per-register P2/P3 array control
- **FIXED:** Lua Buffer fields now properly saved/loaded in export/import
- Enhanced "Calculate Packets" button for preview and validation
...
2. Run: `python modbus_tkinter_app_v6.7_complete.py`
...
4. Expand **"⚙️ Advanced Configuration"** section:
   - **Array Membership:** (leave empty - auto-generated)
   - **Manual Override:** `☐ Unchecked` (v6.7+ - leave off for automatic generation)
...
**Note (v6.7+):** Manual Override checkbox allows you to skip automatic P2/P3 generation and type array membership manually. Leave it **unchecked** for standard workflow.
